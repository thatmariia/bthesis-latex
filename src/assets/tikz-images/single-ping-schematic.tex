...
\begin{tikzpicture}[
    ...
    cnodeex2/.style = {circle,very thick,draw=main-color, fill=main-color, fill opacity=0.2},
    cnodein/.style = {circle,thick,fill=sec-color},
    cnodein2/.style = {circle,very thick,draw=sec-color,fill=sec-color, fill opacity=0.2},
    inarrow/.style = {arr, draw=sec-color, fill=sec-color, ultra thick},
    exarrow/.style = {arr, draw=main-color, fill=sec-color, ultra thick},
    idl/.style = {draw=third-color, fill=sec-color, ultra thick},
]
    ...
    \begin{scope}
        ...
        \node[anchor=west] at (\spltx, \spexy - 0 * \spexy) {ex cells};
        
        % in cells
        \node[cnodein, anchor=west] at (\splx, \spexy - 0.33 * \spexy) {};
        \node[anchor=west] at (\spltx, \spexy - 0.33 * \spexy) {in cells};

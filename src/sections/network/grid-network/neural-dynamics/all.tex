...
\begin{figure}[!htp]
    ...
    \caption[Dynamics of an RS neuron]{Dynamics of an RS neuron depending on current $I_v$.}
...
\begin{figure}[!htp]
    ...
    \caption[Dynamics of an FS neuron]{Dynamics of an FS neuron depending on current $I_v$.}

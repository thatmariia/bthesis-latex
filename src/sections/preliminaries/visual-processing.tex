...
\begin{figure}[!htp]
    ...
    \caption[Visual system and the depiction of size variability of receptive fields]{Visual system and size variability of receptive fields (RF) depending on their eccentricity \cite{KandelBook2003:25}.}
